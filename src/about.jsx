        ...
        <div className="content">
          ...
          <div className="about-content">
            <p>
              ...
              I’m a curious human running on Python, some oranges , and a dangerously long list of side quests — some in code, some in fields or some in video games.<br /><br />
              By day, I’m a CSE student at VIT Chennai, wrangling AI models, dodging semicolons, and negotiating data privacy terms with my Smart Grid (she’s moody, but secure thanks to AES-RSA 🛡️).<br /><br />
              By night, I switch from debugging code to dribbling past defenders on the football field — both require precision, after all.
            </p><br/>
            ...
            <div className="build-worlds">
              <p>
                ...
                • An AI-powered storytelling engine where plot twists are generated from comment section chaos powered by drama + NLP 🎭🤖<br />
              <br />
                When I’m not playing with bytes or boots, I’m ideating my next hackathon win, building productivity tools with flair, or explaining to NPCs why AI is not gonna take our jobs.<br /><br />
                Welcome to my digital dojo — where tech meets storytelling and every project is just one breakpoint away from greatness.<br />
